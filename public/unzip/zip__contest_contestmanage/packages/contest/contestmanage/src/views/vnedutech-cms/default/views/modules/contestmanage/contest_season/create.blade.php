...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.contest_season.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="panel panel-primary" id="hidepanel1">
                ...
                <!-- errors -->
                {!! Form::open(array('url' => route('contest.contestmanage.contest_season.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'examForm', 'files'=> true)) !!}
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <div class="row">
                        <div class="col-md-6">
                            <label>Tên mùa thi</label>
                            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                {!! Form::text('name', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.name_here'))) !!}
                            ...
                            <div class="form-group {{ $errors->first('description', 'has-error') }}">
                                {!! Form::textarea('description', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.description'))) !!}
                                <span class="help-block">{{ $errors->first('description', ':message') }}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>Thông báo trước ngày bắt đầu</label>
                            <div class="form-group {{ $errors->first('before_start_notify', 'has-error') }}">
                                {!! Form::textarea('before_start_notify', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.before_start_notify'))) !!}
                                <span class="help-block">{{ $errors->first('before_start_notify', ':message') }}</span>
                            </div>
                            <label>Thông báo sau ngày kết thúc</label>
                            <div class="form-group {{ $errors->first('after_end_notify', 'has-error') }}">
                                {!! Form::textarea('after_end_notify', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.after_end_notify'))) !!}
                                <span class="help-block">{{ $errors->first('after_end_notify', ':message') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group {{ $errors->first('rules', 'has-error') }}">
                            {!! Form::textarea('rules', null, array('class' => 'form-control', 'id' => 'ckeditor_full','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.rules'))) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{!! route('contest.contestmanage.contest_season.create') !!}"
...
@section('footer_scripts')
    ...
    <script>
        ...
        $('body').on('click','.config', function () {
            ...
            $.post(href, {type: 'season'}, function (res) {
                if(res) {
