                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="u_name" class="form-control" placeholder="{{trans('vne-member::language.placeholder.member.u_name')}}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select id="object" class="form-control" name="object_id" placeholder="{{trans('vne-member::language.placeholder.member.object')}}">
                                            @if(!empty($list_object))
                                                @foreach($list_object as $object)
                                                    <option value="{{$object->object_id}}" >{{$object->name}}</option>     
                                                @endforeach
                                            @endif
                                        </select>
                                    </div> 
