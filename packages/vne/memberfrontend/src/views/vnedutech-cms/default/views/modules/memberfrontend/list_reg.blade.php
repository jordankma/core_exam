...
{{-- Page title --}}
@section('title'){{ $title = 'Top thí sinh đăng ký' }}@stop
						...
						<div class="content">
							...
							<ol class="list list_a">
								...
								<li class="row">
									...
									<div class="col-6 col-md-6 name-city">{{$member_top_a->name}}</div>
									<div class="col-4 col-md-5 number">{{ $member_top_a->user_reg_exam_a }}</div>
								</li>
								@endforeach
								@endif
							</ol>
							...
							<ol class="list list_b">
								...
								<li class="row">
									<div class="col-2 col-md-1 top"> {{ $loop->index+1 }} </div>
									<div class="col-6 col-md-6 name-city"> {{$member_top_b->name}} </div>
									<div class="col-4 col-md-5 number"> {{ $member_top_b->user_reg_exam_b }} </div>
								</li>
								@endforeach
								@endif
							</ol>
