    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <iframe src="https://drive.google.com/file/d/1OiQ0CmXGtjCvu47Cnsvc9DQGdTHOCn2m/preview" width="100%" height="480"></iframe>
                {{-- <iframe src="https://drive.google.com/embeddedfolderview?id=1eZRsS8cTjQvOFSkhQJKR7usWupMa3Ra0#list" style="width:100%; height:600px; border:0;"></iframe> --}}
                <a href="https://drive.google.com/open?id=1Nwse8F2Ry64YUW-jgQcU7z8nlLkqlK2o" target="_blank">open pdf</a>
            </div>
        </div>
        <!--main content ends-->
    </section>
