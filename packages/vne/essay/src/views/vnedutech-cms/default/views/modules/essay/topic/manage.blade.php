...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-essay::language.titles.topic.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('vne.essay.topic.create'))
                        <a href="{{ route('vne.essay.topic.create') }}" class="btn btn-sm btn-default">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('vne-essay::language.table.topic.name') }}</th>
                                ...
                                <th>{{ trans('vne-essay::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.essay.topic.data') }}',
                columns: [
                    { data: 'DT_Row_Index', name: 'essay_topic_id' },
                    { data: 'name', name: 'name' },
